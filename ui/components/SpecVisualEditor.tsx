...
import { Search, X, Target, Rocket } from 'lucide-react';
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-cloudflare-orange focus:border-transparent"
            />
            {searchQuery && (
              <button
              ...
              {isGenerating ? (
                ...
                <>
                  <div className="text-center px-4 py-6 space-y-3">
                    {isDragOver ? (
                      <Target className="w-12 h-12 mx-auto text-orange-600" />
                    ) : (
                      <Target className="w-12 h-12 mx-auto text-slate-400" />
                    )}
                    <div className="space-y-2">
                  ...
                  {onGenerateAll && endpoints.length > 0 && (
                    <div className="mb-4 flex flex-col gap-2 w-full px-4">
                      <button
                        ...
                        className="w-full px-4 py-2 bg-cloudflare-orange text-white rounded-lg hover:bg-orange-600 font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                      >
                        <Rocket className="w-4 h-4" /> Generate All {endpoints.length} Endpoints
                      </button>
